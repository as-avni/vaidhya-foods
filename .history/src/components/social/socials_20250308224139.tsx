...
export default function SocialDashboard() {
  return (
    <main className="min-h-screen bg-[#ffffff] text-black py-6 px-4">
      <div className="container mx-auto max-w-7xl">
        <h2 className="md:text-4xl text-center mb-8 font-sriracha">
          Social Media Dashboard
        </h2>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border border-green-800 rounded-2xl overflow-hidden bg-green-200 shadow-2xl">
            <div className="flex items-center p-3 border-b border-green-800 rounded-full">
          ...
          <div className="border border-green-800 rounded-2xl overflow-hidden bg-green-300 shadow-2xl">
            <div className="flex items-center p-3 border-b border-green-800 rounded-full">
