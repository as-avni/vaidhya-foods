    ...
    <main className="min-h-screen bg-[#ffffff] text-black py-6 px-4">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="border border-green-800 rounded-md overflow-hidden bg-green-300">
          ...
          <div className="border border-green-800 rounded-full rounded-md overflow-hidden bg-green-300">
