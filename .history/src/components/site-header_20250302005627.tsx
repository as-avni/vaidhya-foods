...
return (
<header className=" bg-white-100 bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-xl z-50 ">
      <div className="mx-auto px-4 py-4 flex items-center justify-between">

        {/* Logo & Title */}
        <div className="flex items-center gap-2">
          <Image src="/img/logo-vaidhya.png" alt="Logo" width={40} height={40} className="h-10 w-auto" />
          <span className="text-lg font-bold text-white-700 font-serif px-8 md:px-0">Vaidhya Dairy</span>
        </div>
