export default function WhyUs() {
  const features = [
    ...
    { title: "Freshness Guaranteed", text: "Delivered fresh to retain nutritional value and flavor.",data:"M6 10 L12 4 L18 10 L6 10 Z M8 10 L8 14 L16 14 L16 10 M6 14 L12 20 L18 14 L6 14 Z M10 14 L10 16 
        M14 14 L14 16
" },
  ];
