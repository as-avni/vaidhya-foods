...
export default function Hero() {
  ...
  return (
    <section className="relative h-fit md:h-screen pt-0 overflow-hidden">
  {/* Background Images */}
  {backgroundImages.map((image, index) => (
    <div
      key={index}
      className={`absolute inset-0 w-full h md:h-full bg-[length:120%] sm:bg-center transition-opacity duration-1000 ${
