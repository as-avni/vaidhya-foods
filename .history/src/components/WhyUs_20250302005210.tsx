      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          {features.map((item, index) => (
            <div key={index} className="md:p-10 md:w-[30%] bg-white text-black p-16 rounded-lg  flex flex-col items-center border-l-2 border-b-2 border-black shadow-[4px_4px_0px_#4a4a4a]">
