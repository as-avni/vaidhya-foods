    ...
    <div className="max-w-2xl">
      ...
      <div className="flex flex-col space-y-4 items-center justify-center sm:flex-row sm:space-y-0 sm:gap-4">
        ...
        <button
          ...
          className="btn text-black bg-green-300 rounded-full flex flex-wrap gap-2 hover:bg-white px-6 py-3 text-lg md:text-xl"
        >          
          <PlayCircle className="h-7 w-6 text-black" strokeWidth={1.5} />
          View Our Product
        </button>
      </div>
    </div>
