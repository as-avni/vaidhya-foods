export default function WhyUs() {
  const features = [
    ...
    { title: "Freshness Guaranteed", text: "Delivered fresh to retain nutritional value and flavor.",d: },
  ];
              ...
              <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-100 mb-4">
                ...
                >
                  <path
                    ...
                    strokeWidth={2}
                    d="M6 3h12a2 2 0 0 1 2 2v14a2 2 0 0 1 -2 2h-12a2 2 0 0 1 -2 -2v-14a2 2 0 0 1 2 -2z M9 3a3 2 0 0 1 6 0M9 15v3 M12 11v7M15 7v11"
                  />
                </svg>
              </div>
