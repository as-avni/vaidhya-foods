...
export default function ContactUs() {
  ...
  const mapUrl =
    "https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d224.5392103255816!2d81.51099193644087!3d21.25108934301077!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3a2920066e759459%3A0x15c8119f028ae75d!2sManna%20Engineering%20Works!5e1!3m2!1sen!2sin!4v1743601114460!5m2!1sen!2sin"
      ...
      <div className="container space-y-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="flex items-start gap-4">
            <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 mt-1 rounded-full bg-[#98be52]">📞</div>
            <div>
          ...
          <div className="flex items-start gap-4">
            <div className="flex items-center justify-center flex-shrink-0 w-12 h-12 mt-1 rounded-full bg-[#98be52]">✉️</div>
            <div>
