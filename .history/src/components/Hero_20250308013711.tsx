      ...
      <div className="relative bg-green-200 bg-opacity-90 rounded-lg p-6 h-3/4 w-full max-w-sm">
        ...
        <div className="w-full h-full">
          <iframe
            ...
            width="450"
            height="315"
            src="https://drive.google.com/file/d/15y7KOy-yLyMxYmkSzpyJUXI57-MqJNGn/preview?autoplay=1&loop=1" // Replace VIDEO_ID with the actual ID of the YouTube Short
            title="YouTube Short"
            frameBorder="0"
