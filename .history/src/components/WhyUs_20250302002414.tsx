export default function WhyUs() {
  const features = [
    ...
    { title: "Authentic Taste", text: "Preserving the traditional flavors of dairy products.",data:"M12 3 L4 9 L7 9 L12 5 L17 9 L20 9 L12 3 M4 9 L12 21 L20 9 M7 9 L17 9 M12 5 L12 15" },
