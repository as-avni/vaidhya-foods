    ...
    <section className="relative md:h-screen pt-0 overflow-hidden">
      ...
      <div className="container relative z-10 flex flex-col items-start justify-center h-full text-white">
        <div className="max-w-2xl">
          ...
          <p className="mb-8 text-lg md:text-xl font-inter">Creamy, Dreamy, And Always Fresh</p>
          <div className="flex flex-wrap gap-4">
            <Link href="#products" className="btn btn-primary text-xs md:text-xl rounded-full">
              What We Serve
            </Link>
            <Link href="#contact" className="btn btn-secondary  text-xs md:text-xl rounded-full">
              View Our Product
            </Link>
          </div>
        </div>
