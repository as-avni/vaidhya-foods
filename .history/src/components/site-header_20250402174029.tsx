...
export default function SiteHeader() {
  ...
  return (
    <header className="bg-white bg-opacity-80 backdrop-blur-md shadow-lg flex flex-row sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-xl z-50">
      ...
      <div className="absolute top-0 left-4 md:left-10 transform -translate-y-1/2 bg-white shadow-md px-4 py-2 rounded-full">
        <Link href="/">
          <div className="flex items-center gap-2">
            ...
            />
            <span className="text-xl font-bold text-black font-sriracha hidden md:block"></span>
          </div>
        </Link>
      </div>
