...
export default function Hero() {
  ...
  {isModalOpen && (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50">
      <div className="relative bg-green-200 bg-opacity-90 rounded-lg p-2 h-3/4 w-full max-w-sm">
        <button
        ...
        <div className="w-full h-full">
          <iframe
            ...
            width="450"
            height="315"
            src="https://drive.google.com/file/d/15y7KOy-yLyMxYmkSzpyJUXI57-MqJNGn/preview" // Replace VIDEO_ID with the actual ID of the YouTube Short
            title="YouTube Short"
            frameBorder="0"
