    ...
    <div>
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="text-center">
          <button type="submit" disabled={isSubmitting} className="px-8 py-2 font-medium text-black transition-colors rounded-2xl bg-green-300 hover:bg-green-400 focus:outline-none focus:ring-2 focus:ring-green-200 focus:ring-offset-2">
