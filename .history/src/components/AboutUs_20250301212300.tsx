  ...
  return (
    <section id="about" className="py-20 bg-white">
      <div className="container">
        <h2 className="text-center md:text-4xl font-bold mb-8">Learn More About Us</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="hidden md:block h-full">
            <Image
              ...
              width={600}
              height={800}
              className="object-cover w-full h-[90%] rounded-lg"
            />
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="relative w-100 h-100 mx-auto md:mx-0">
              {!isVideoPlaying ? (
                <>
                  <Image
