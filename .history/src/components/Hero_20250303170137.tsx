...
export default function Hero() {
  ...
  {isModalOpen && (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-75 z-50">
      <div className="relative bg-green-200 bg-opacity-90 rounded-lg p-6 w-full max-w-5xl">
        <button
        ...
        <div className="w-full">
          <iframe
            ...
            width="560"
            height="315"
            src="https://www.youtube.com/embed/VIDEO_ID" https://youtube.com/shorts/lwDRgXvMNmQ?si=UwmdAjVF3erYrtNx// Replace VIDEO_ID with the actual ID of the YouTube Short
            title="YouTube Short"
            frameBorder="0"
