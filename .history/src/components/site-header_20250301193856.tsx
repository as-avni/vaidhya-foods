...
<header className=" bg-[#f5f2ee] bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-lg z-50 ">
      <div className="mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-6 text-sm">
          ...
          <Link href="/events" className="relative text-gray-600 hover:text-orange-700 text-lg after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-orange-700 after:transition-all after:duration-300 hover:after:w-full">
            Contact Us
          </Link>
