    ...
    <section id="products" className="py-20 bg-white">
      ...
      {selectedProduct && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-green-100 bg-opacity-0 w-[95%] md:w-[90%] h-[95%] md:h-80%] rounded-3xl flex flex-col md:flex-row overflow-hidden relative">
            <button 
            ...
            <div className="md:w-1/2 w-full h-1/2 md:h-full p-6 flex flex-col justify-center">
              ...
              <p className="text-sm mb-4 leading-[0.7]"><strong>Ingredients: </strong>{selectedProduct.ingredients}</p>
              <p className="text-sm mb-4 leading-[0.7]"><strong>Process: </strong> {selectedProduct.process}</p>
              <p className="text-sm mb-4 leading-[0.7]"><strong>Uses: </strong> {selectedProduct.uses}</p>
              <p className="text-sm mb-4 leading-[0.7]"><strong>Storage: </strong> {selectedProduct.storage}</p>
              <p className="text-sm mb-4 leading-[0.7]"><strong>Available in: </strong>{selectedProduct.variants}</p>
            </div>
          </div>
        </div>
      )}
