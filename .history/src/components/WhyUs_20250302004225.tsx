export default function WhyUs() {
  const features = [
    ...
    { title: "Freshness Guaranteed", text: "Delivered fresh to retain nutritional value and flavor.",data:"M4.98 1 a.5 .5 0 0 0 -.39 .188 L1.54 5 H6 a.5 .5 0 0 1 .5 .5 1.5 1.5 0 0 0 3 0 A.5 .5 0 0 1 10 5 h4.46 l-3.05 -3.812 A.5 .5 0 0 0 11.02 1 H4.98 Z M3.81 .563 A1.5 1.5 0 0 1 4.98 0 h6.04 A1.5 1.5 0 0 1 12.19 .563 l3.7 4.625 a.5 .5 0 0 1 .106 .374 l-.39 3.124 A1.5 1.5 0 0 1 14.117 10 H1.883 A1.5 1.5 0 0 1 .394 8.686 l-.39 -3.124 a.5 .5 0 0 1 .106 -.374 L3.81 .563 Z M.125 11.17 A.5 .5 0 0 1 .5 11 H6 a.5 .5 0 0 1 .5 .5 1.5 1.5 0 0 0 3 0 A.5 .5 0 0 1 10 11 h5.5 a.5 .5 0 0 1 .496 .562 l-.39 3.124 A1.5 1.5 0 0 1 14.117 16 H1.883 A1.5 1.5 0 0 1 .394 14.686 l-.39 -3.124 a.5 .5 0 0 1 .121 -.393 Z" },
  ];
