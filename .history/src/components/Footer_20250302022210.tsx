        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4">
              <Link href="https://www.facebook.com/profile.php?id=61573041901527" target="blank" aria-label="Facebook">
                <Facebook className="h-6 md:h-10 w-6 md:w-10 hover:text-green-500 transition-colors" />
              </Link>
              <Link href="https://www.instagram.com/vaidhya.foods/" aria-label="Instagram">
                <Instagram className="h-6 md:h-10 w-6 md:w-10 hover:text-green-500 transition-colors" />
              </Link>
              <Link href="#" aria-label="Twitter">
                <Twitter className="h-6 md:h-10 w-6 md:w-10 hover:text-green-500 transition-colors" />
              </Link>
