export default function WhyUs() {
  return (
    <section className="py-20 flex justify-around bg-gray-50">
      <div className=" grid grid-cols-12 gap-4">
        {/* First Box - 2/5 width */}
        <div className="col-span-3 bg-green-300 text-white p-8 rounded-lg">
        ...
        {/* Remaining 3 Boxes - 1/5 width each */}
        {[  
          ...
          <div key={index} className="col-span-2 bg-white text-black p-6 rounded-lg shadow-md flex flex-col items-center">
            <div className="w-12 h-12 flex items-center justify-center rounded-full bg-gray-300 mb-4">
              <svg
            ...
            <h3 className="text-xl font-bold mb-2 ext">{item.title}</h3>
