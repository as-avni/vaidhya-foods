...
return (
<header className=" bg-green-50 bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-xl z-50 ">
      <div className="mx-auto px-4 py-4 flex items-center justify-between">

        {/* Logo & Title */}
        <div className="flex items-center gap-2">
          <Image src="/img/logo-vaidhya.png" alt="Logo" width={40} height={40} className="h-10 w-auto" />
          <span className="text-lg font-bold text-gray-700 font-serif px-8 md:px-0">Vaidhya Dairy</span>
        </div>
        ...
        <Link href="/#reg-form" className="relative text-gray-600  text-lg font-semibold after:absolute after:bottom-0 after:left-0">
            <Button className="bg-black hover:bg-green-600 text-white px-4 py-2 rounded-full hidden md:block">Call Us</Button>
          </Link>
      ...
      {isOpen && (
        <div className="md:hidden bg-green-50 py-4 px-4 shadow-lg ">
          <nav className="absolute top-16 left-0 w-full bg-green- shadow-lg py-4 flex flex-col items-center gap-4 md:hidden">
          <Link href="/" className="relative text-black hover:text-green-600 text-base/[30px] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-green-600 after:transition-all after:duration-300 hover:after:w-full">
            Home
          </Link>
          <Link href="/#about" className="relative text-black hover:text-green-600 text-base/[30px] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-green-600 after:transition-all after:duration-300 hover:after:w-full">
          ...
          <Link href="/#reg-form" className="w-full relative text-black  text-lg font-semibold after:absolute after:bottom-0 after:left-0">
            <Button className="w-full bg-black hover:bg-green-600 text-white rounded-full">Become a Member</Button>
          </Link>
          </nav>
        </div>
      )}
