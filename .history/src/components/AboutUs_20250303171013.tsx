...
export default function AboutUs() {
  ...
  {!isVideoPlaying ? (
    <>
      ...
      />
      <button
        onClick={() => setIsVideoPlaying(true)} // Change this to set the state to play the video
    ...
    <div className="w-full h-full">
      <iframe
        width="100%"
        height="100%"
        src="https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1" // Replace with your YouTube video link
