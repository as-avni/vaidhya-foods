    ...
    <section className="py-20 bg-gray-50 flex justify-center">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          <div className="h-auto md:w-[50%] bg-green-300 text-black p-8 rounded-lg flex flex-col justify-center">
          ...
          {features.map((item, index) => (
            <div key={index} className="md:p-6 md:w-[30%] bg-white text-black p-16 rounded-lg shadow-md flex flex-col items-center">
