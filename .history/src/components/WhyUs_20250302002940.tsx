export default function WhyUs() {
  const features = [
    ...
    { title: "Authentic Taste", text: "Preserving the traditional flavors of dairy products.",data:"M50 15 L65 35 L50 50 L35 35 Z M35 35 L50 50 L65 35 M50 15 L35 35 L50 22.5 L65 35 Z" },
