export default function WhyUs() {
  return (
    <section className="py-20 w-9/10 flex justify-center bg-gray-50">
      <div className="w-9/10 grid grid-cols-5 gap-4">
        {/* First Box - 2/5 width */}
        <div className="col-span-2 bg-green-300 text-white p-8 rounded-lg">
        ...
        {[  
          ...
          <div key={index} className="col-span-1 bg-white text-black p-6 rounded-lg shadow-md flex flex-col items-center">
