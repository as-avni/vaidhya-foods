...
import { MapPin, Phone, Clock, Twitter, Facebook, Instagram, Youtube } from "lucide-react"
    ...
    <footer className="w-full bg-gray-50 text-black">
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            <h3 className="font-semibold text-lg mb-4 hover:text-green-500">Follow Us</h3>
            <div className="flex gap-4">
              <Link href="#" aria-label="Facebook">
                <Facebook className="h-6 md:h-10 w-6 md:-10 hover:text-green-500 transition-colors" />
              </Link>
              <Link href="#" aria-label="Instagram">
                <Instagram className="h-6 md:h-10 w-6 md:-10 hover:text-green-500 transition-colors" />
              </Link>
              <Link href="#" aria-label="Twitter">
                <Twitter className="h-6 md:h-10 w-6 md:-10 hover:text-green-500 transition-colors" />
              </Link>
              <Link href="#" aria-label="LinkedIn">
                <Youtube className="h-6 md:h-10 w-6 md:-10 hover:text-green-500 transition-colors" />
              </Link>
            </div>
          </div>
        </div>
