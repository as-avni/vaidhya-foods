                ...
                <div className="relative bg-green-200 bg-opacity-90 rounded-lg p-6 h-3/4 w-full max-w-xl">
                  ...
                  <div className="w-full h-full">
                    <iframe
                      ...
                      width="560"
                      height="315"
                      src="https://www.youtube.com/embed/s1D1fpvl-A0?si=QOurgyxC-9429NVc&autoplay=1&loop=1&playlist=s1D1fpvl-A0?si=QOurgyxC-9429NVc" // Replace VIDEO_ID with the actual ID of the YouTube Short
                      title="YouTube Short"
                      frameBorder="0"
