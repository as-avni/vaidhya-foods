      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          {features.map((item, index) => (
            <div key={index} className="md:p-10 md:w-[30%] bg-white text-black p-16 rounded-lg shadow-md flex flex-col items-center hover:bg-black hover:text-white">
              {/* Unique icon instance for each box */}
              <div className="w-12 h-12 flex items-center mx-auto justify-center rounded-full bg-gray-100 mb-4 hover:bg-black">
                <svg
