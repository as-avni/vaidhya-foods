...
<header className=" bg-white bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-lg z-50 ">
      <div className="mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav className="hidden md:flex gap-6 text-sm">
          <Link href="/" className="relative text-gray-600 hover:text-green-600 text-base/[30px] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-green-600 after:transition-all after:duration-300 hover:after:w-full">
            Home
          </Link>
          ...
          <Link href="/#products" className="relative text-gray-600 hover:text-green-600 text-base/[30px] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-green-600 after:transition-all after:duration-300 hover:after:w-full">
            Our Products
          </Link>
          <Link href="/#contact" className="relative text-gray-600 hover:text-green-600 text-base/[30px] after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-green-600 after:transition-all after:duration-300 hover:after:w-full">
            Contact Us
          </Link>
