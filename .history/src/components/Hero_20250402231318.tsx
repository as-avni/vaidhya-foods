...
export default function Hero() {
  ...
  return (
    <section className="relative h-lvh md:h-screen pt-0 overflow-hidden">
  {/* Background Images */}
  ...
  {/* Content */}
  <div className="container top-0 md:top-0 md:mt-0 relative z-10 flex flex-col items-start h-full text-white">
    <div className="max-w-2xl">
      <h1 className="mt-40 mb-4 text-5xl font-bold font-sriracha text-center leading-tight md:text-6xl">
        Taste of Purity
      </h1>
      <p className="mb-8 text-xl font-sriracha">Creamy, Dreamy, And Always Fresh</p>
      <div className="flex flex-wrap gap-4">
        <Link href="#products" className="bg-green-300 text-black btn rounded-full hover:bg-white px-4 py-2 text-sm md:px-6 md:py-3 md:text-base">
          What We Serve
        </Link>
        <button
          onClick={() => setIsModalOpen(true)}
          className="btn text-black bg-green-300 rounded-full flex flex-wrap gap-2 hover:bg-white px-4 py-2 text-sm md:px-6 md:py-3 md:text-base"
        >          
