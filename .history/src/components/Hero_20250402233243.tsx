  ...
  <div className="container top-0 md:top-0 md:mt-0 relative z-10 flex flex-col items-start justify-center h-full text-white">
    <div className="max-w-2xl">
      ...
      <div className="flex flex-wrap gap-4 items-center justify-center">
        <Link href="#products" className="bg-green-300 text-black btn rounded-full hover:bg-white w-24 text-xs md:w-auto md:text-sm">
          What We Serve
        </Link>
        <button
          onClick={() => setIsModalOpen(true)}
          className="btn text-black bg-green-300 rounded-full flex flex-wrap gap-2 hover:bg-white w-24 text-xs md:w-auto md:text-sm"
        >          
