...
//         {/* Contact Form */}
//         <section className="">
//             <div className="max-w-8xl p-8 bg-white rounded-lg shadow-lg">
...
//                   <button type="submit" className="px-8 py-3 font-medium text-white transition-colors rounded-2xl bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">Send</button>
//                 </div>
//               </form>
//             </div>
//         </section>
...
const ContactForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const response = await fetch("https://localhost:5005/api/contact", {
        method: "POST",
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      <div className="text-center">
        <button type="submit" disabled={isSubmitting} className="px-8 py-3 font-medium text-white transition-colors rounded-2xl bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 focus:ring-offset-2">
