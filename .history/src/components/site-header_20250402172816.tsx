...
<header className=" bg-white bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-xl z-50 ">
      ...
      <Link href="/">
        <div className="flex items-center gap-2">
          <Image src="https://drive.google.com/uc?export=view&id=1Qz3RdEXLgXk0V_xjMcnYZeFiTkE36xif" alt="Logo" width={40} height={40} className="h-50 w-60 z-50" />
          <span className="text-xl font-bold text-black font-sriracha px-8 md:px-0"></span>
        </div>
        </Link>
