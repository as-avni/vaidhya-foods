  ...
  <div className="container top-0 md:top-0 md:mt-0 relative z-10 flex flex-col items-center justify-center h-full text-white">
    <div className="max-w-2xl">
      ...
      <div className="flex flex-col space-y-4 items-center justify-center sm:flex-row sm:space-y-0 sm:gap-4">
        <Link href="#products" className="bg-green-300 text-black btn rounded-full hover:bg-white w-32 px-4 py-2 text-sm md:w-auto md:px-6 md:py-3 md:text-lg">
          What We Serve
        </Link>
        <button
          onClick={() => setIsModalOpen(true)}
          className="btn text-black bg-green-300 rounded-full flex flex-wrap gap-2 hover:bg-white w-32 px-4 py-2 text-sm md:w-auto md:px-6 md:py-3 md:text-lg"
        >          
