  ...
  return (
    <section className="py-20 bg-gray-50 flex justify-center">
      <div className="container mx-auto px-6">
        <div className="flex flexmd:flex-row gap-6">
          {/* First Box - Main Highlight */}
          <div className="w-[50%] bg-green-300 text-white p-8 rounded-lg flex flex-col justify-center">
          ...
          {features.map((item, index) => (
            <div key={index} className="w-[30%] bg-white text-black p-6 rounded-lg shadow-md flex flex-col items-center">
