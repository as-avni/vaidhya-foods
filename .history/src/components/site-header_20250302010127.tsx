...
<header className=" bg-green-50 bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-xl z-50 ">
      ...
      {isOpen && (
        <div className="md:hidden bg-green-50 py-4 px-4 shadow-lg ">
          ...
          <Link href="/#reg-form" className="w-full relative text-black  text-lg font-semibold after:absolute after:bottom-0 after:left-0 justify-center item-center align-center">
            <Button className="w-1/2  bg-black hover:bg-green-600 text-white rounded-full">Become a Member</Button>
          </Link>
          </nav>
        </div>
      )}
