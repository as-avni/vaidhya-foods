    ...
    <section className="py-20 bg-gray-50 flex justify-center">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-6 ">
          ...
          <div className="h-auto md:w-[50%] bg-green-300 text-black p-12 md:p-8 rounded-lg flex flex-col justify-cente border-b-2 border-black shadow-[8px_8px_0px_#4a4a4a]r">
