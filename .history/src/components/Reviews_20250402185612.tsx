  ...
  const reviews = [
    {
      ...
      image: "https://res.cloudinary.com/dhi3iupue/image/upload/v1743600287/testimonials-2_t8h0gq.png",
      rating: 5,
    ...
    },
    {
      ...
      name: "Priya Sharma",
      position: "Home Chef",
      image: "https://res.cloudinary.com/dhi3iupue/image/upload/v1743600286/testimonials-1_f02mqr.png",
      rating: 5,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dhi3iupue/image/upload/v1743600287/testimonials-4_cloky2.png",
      rating: 4,
    ...
    },
    {
      ...
      image: "https://res.cloudinary.com/dhi3iupue/image/upload/v1743600286/testimonials-3_c6wlc9.png",
      rating: 5,
  ...
  return (
    <section className="py-20 bg-gray-50">
      <div className="container">
        <h2 className="section-title font-sriracha leading-tight">What Are They Saying About Us</h2>
                ...
                <div key={review.id} className="flex-shrink-0 w-full p-8 md:p-12" style={{ width: "100%" }}>
                  <div className="flex flex-col items-center md:flex-row md:items-start">
                    ...
                    <div className="flex-grow text-center md:text-left">
                      <p className="mb-6 text-lg ">&ldquo;{review.text}&rdquo;</p>
