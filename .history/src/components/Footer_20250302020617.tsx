        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="flex flex-col">
            ...
            <div className="text-sm">
              <p className="mb-1">
                <span className="font-medium">Phone:</span> <a href="mailto:vaidhyafoods6266@gmail.com" className="hover:underline">
          ...
          <div className="flex flex-col">
            ...
            <div className="flex gap-4">
              ...
              <Link href="#" aria-label="LinkedIn">
                <Youtube className="h-5 w-5 hover:text-gray-500 transition-colors" />
              </Link>
            </div>
          </div>
        </div>
