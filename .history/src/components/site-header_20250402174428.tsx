...
export default function SiteHeader() {
  ...
  return (
    <header className="bg-white bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 w-full px-4 md:px-10 py-3 flex items-center justify-between z-50">
