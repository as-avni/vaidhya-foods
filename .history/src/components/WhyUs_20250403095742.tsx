    ...
    <section className="py-20 bg-gray-50 flex justify-center">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-6 ">
          ...
          <div className="h-auto md:w-[50%] bg-[#a6c470] text-black p-12 md:p-8 rounded-3xl flex flex-col justify-center shadow-lg shadow-black">
          ...
          {features.map((item, index) => (
            <div key={index} className="md:p-10 md:w-[30%] bg-white text-black p-16 rounded-3xl flex flex-col items-center shadow-lg shadow-black">
              ...
              <h3 className="text-xl mb-2 text-center leading-tight">{item.title}</h3>
