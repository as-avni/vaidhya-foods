...
<header className=" bg-[#f5f2ee] bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-lg z-50 ">
      ...
      {isOpen && (
        <div className="md:hidden bg-white py-4 px-4 shadow-lg ">
          ...
          <Link href="/" className="relative text-gray-600 hover:text-green-700 text-lg font-semibold after:absolute after:bottom-0 after:left-0 after:w-0 after:h-[2px] after:bg-orange-700 after:transition-all after:duration-300 hover:after:w-full">
            Home
          </Link>
