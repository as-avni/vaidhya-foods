export default function WhyUs() {
  const features = [
    ...
    { title: "Authentic Taste", text: "Preserving the traditional flavors of dairy products.",data:"M131 0 L162 50 L131 100 L100 50 Z M100 50 L131 100 L162 50 M131 100 L165 50 L131 180 L97 50" },
