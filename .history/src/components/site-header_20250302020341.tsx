...
<header className=" bg-white bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-xl z-50 ">
      <div className="mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="text-xl font-bold text-black font-roboto px-8 md:px-0">Vaidhya Foods</span>
        </div>
        ...
        {/* Desktop Button */}
        <Link href="/#reg-formtel:+917566645359" className="relative text-gray-600  text-lg font-semibold after:absolute after:bottom-0 after:left-0">
