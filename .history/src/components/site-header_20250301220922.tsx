...
<header className=" bg-green-100 bg-opacity-80 backdrop-blur-md shadow-lg sticky md:fixed top-0 md:top-3 left-0 md:left-10 w-[98%] md:w-[95%] mx-auto rounded-lg z-50 ">
      <div className="mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <Image src="/img/logo-vaidhya.png" alt="Logo" width={40} height={40} className="h-10 md:h-20 w-auto px-20" />
          <span className="text-lg font-bold text-gray-700 font-serif ">Vaidhya Dairy</span>
        </div>
