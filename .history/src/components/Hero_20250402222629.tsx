...
export default function Hero() {
  ...
  {/* Content */}
  <div className="container md:mt-0 mt-8 relative z-10 flex flex-col items-center justify-center h-full text-white text-center">
    <div className="max-w-2xl">
      <h1 className="mb-4 text-2xl font-bold font-sriracha leading-tight md:text-6xl sm:text-4xl">
        Taste of Purity
      </h1>
      <p className="mb-8 text-lg font-sriracha">Creamy, Dreamy, And Always Fresh</p>
