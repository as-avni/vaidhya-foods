export default function WhyUs() {
  const features = [
    ...
    { title: "Authentic Taste", text: "Preserving the traditional flavors of dairy products.",data:"M5 9 L12 2 L19 9 L15 20 L9 20 Z M12 2 L15 9 M12 2 L9 9 M5 9 L19 9 M9 20 L15 20" },
