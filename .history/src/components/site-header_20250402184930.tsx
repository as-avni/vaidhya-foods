      ...
      <nav className="hidden md:flex gap-8">
        {["Home", "About Us", "Our Products", "Contact Us"].map((item, index) => (
          <Link
            ...
            className="text-black hover:text-red-600 text-sm font-medium transition-all duration-300 relative after:content-[''] after:absolute after:left-0 after:bottom-[-2px] after:w-0 after:h-[2px] after:bg-green-600 after:transition-all after:duration-300 hover:after:w-full"
          >
            {item}
          </Link>
        ))}
