      ...
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row gap-6">
          ...
          {features.map((item, index) => (
            <div key={index} className="md:p-10 md:w-[30%] bg-white text-black p-16 rounded-lg shadow-3xl flex flex-col items-center inset-0 border-l-2 border-b-2 border-gray-500 translate-x-1 translate-y-1">
